function out = fade(inp, len, fadein, fadeout, offset)

% FADE crop/extend and fade in/out a vector.
%
% OUT = FADE(INP, LEN, FADEIN, FADEOUT, OFFSET) crops or extends with zeros the signal INP
...
% Copyright (c) 2003-2010 Piotr Majdak <piotr@majdak.com> (Acoustics Research Institute - Austrian Academy of Sciences)
